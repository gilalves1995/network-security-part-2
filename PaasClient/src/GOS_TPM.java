...
public class GOS_TPM {
	...
	// Configuration file
	private static final String CONFIGURATION_FILE = "GOS_TPM.conf";
	...
	private static final String GOS_PROOFS_SCRIPT = "gos-attest-proofs.sh";
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("The module GOS-TPM is running on address " + address + " and on port " + port + ".");
	...
	private static byte [] getProofs() {
		try {
			String [] command = new String[] {"sh", GOS_PROOFS_SCRIPT};
